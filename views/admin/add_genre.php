...
<body>
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="genre_name" id="genre_name" placeholder="Nhập tên thể loại" required>
            <button type="submit" name="add_genre">Thêm thể loại</button>
        </form>
        <a href="http://localhost/movie_booking/views/admin/manage_genres.php" class="back-btn">Quay lại Quản lý Thể loại</a>
    </div>
</body>
</html>
